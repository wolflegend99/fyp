...
class Dataset():
    ...
    def preprocess(self): # this is a specific function only for this "Churn modelling" dataset
    ...
    def split(self, X, y, fraction=TEST_SPLIT_FRACTION):
    ...
    def sample(self, data, limit=C.RANDOM_SAMPLE_LIMIT):
